...
// ── MatchCard ──────────────────────────────────────────
function MatchCard({ profile, score, breakdown, matchedSkills, skills, showTelegram, actions }) {
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        {score && (
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '0.65rem', color: '#94A3B8', fontWeight: 600, letterSpacing: '0.05em' }}>
              MATCH
            </div>
          </div>
        )}
...
function EmptyState({ message, sub }) {
  return (
    <div style={{ textAlign: 'center', padding: '6rem 2rem' }}>
      <p style={{ fontSize: '1.1rem', color: '#475569', fontWeight: 600, marginBottom: '0.5rem' }}>
        {message}
      </p>
...
const activeTabStyle = {
  ...tabStyle, color: '#1E3A8A', borderBottom: '2px solid #F97316', fontWeight: 700,
}
const countBadge = {
  background: '#E2E8F0', color: '#475569', borderRadius: '99px',
...
const categoryStyle   = {
  padding: '0.4rem 1rem', borderRadius: '99px', border: '1px solid #E2E8F0',
  background: '#FFFFFF', color: '#475569', fontSize: '0.85rem', fontWeight: 500,
  cursor: 'pointer', fontFamily: "'Poppins', sans-serif",
}
const activeCategoryStyle = {
  ...categoryStyle, background: '#1E3A8A', border: '1px solid #1E3A8A', color: '#FFFFFF',
}
const gridStyle = {
...
const skillLabelStyle = {
  ...
  letterSpacing: '0.05em', fontWeight: 700, margin: '0 0 0.35rem 0',
}
...
const learnBadgeStyle = {
  padding: '0.2rem 0.6rem', borderRadius: '99px', fontSize: '0.78rem',
  fontWeight: 500, backgroundColor: '#FFEDD5', color: '#9A3412',
}
const telegramStyle   = {
...
const breakdownStyle  = {
  display: 'flex', gap: '0.5rem', flexWrap: 'wrap', fontSize: '0.72rem',
  color: '#94A3B8', borderTop: '1px solid #F1F5F9', paddingTop: '0.75rem',
}
const connectBtnStyle = {
  width: '100%', padding: '0.7rem', background: '#F97316', border: 'none',
  borderRadius: '8px', color: 'white', fontSize: '0.9rem', fontWeight: 600,
  cursor: 'pointer', fontFamily: "'Poppins', sans-serif",
}
const acceptBtnStyle  = {
  flex: 1, padding: '0.7rem', background: '#1E3A8A', border: 'none',
  borderRadius: '8px', color: 'white', fontSize: '0.9rem', fontWeight: 600,
  cursor: 'pointer', fontFamily: "'Poppins', sans-serif",
}
const declineBtnStyle = {
  flex: 1, padding: '0.7rem', background: 'transparent', border: '1px solid #E2E8F0',
  borderRadius: '8px', color: '#94A3B8', fontSize: '0.9rem', fontWeight: 600,
  cursor: 'pointer', fontFamily: "'Poppins', sans-serif",
}
const sessionBtnStyle = {
  width: '100%', padding: '0.7rem', background: '#1E3A8A', border: 'none',
  borderRadius: '8px', color: 'white', fontSize: '0.85rem', fontWeight: 600,
  cursor: 'pointer', fontFamily: "'Poppins', sans-serif",
}